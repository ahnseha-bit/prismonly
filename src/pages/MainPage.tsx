    ...
    <div className="fluid-container pt-[10vh] md:pt-[12vh] pb-[6vh] md:pb-[10vh] min-h-screen flex flex-col relative z-10">
      ...
      >
        ...
        <div className="text-center shrink-0 mt-4 md:mt-0 flex flex-col items-center">
          <span className="bg-accent-gold text-white px-4 py-0.5 text-[11px] md:text-sm rounded-full tracking-widest uppercase font-serif inline-block mb-4 md:mb-5 leading-tight">
            Countdown to Prism
          </span>
